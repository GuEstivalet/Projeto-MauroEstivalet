...
const Curso = () => {
  return (
    <section>
        <div className={`${styles.curso} animeLeft`}>
            <img src='/assets/contato-image.jpg'alt='Imagem do Dr. Mauro Estivalet'  />
            <p>
        ...
        <div className={styles.cursosec}>
            ...
            <img src='/assets/hero-image.jpg'alt='Imagem do Dr. Mauro Estivalet'  />
        </div>
